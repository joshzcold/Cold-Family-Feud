...
export default function QuestionBoard(props) {
  ...
  return (
    <div class="flex flex-row items-center min-w-full">
      <div
        class="rounded-3xl border-black grid lg:grid-rows-4 lg:grid-flow-col  p-3 mx-10 mb-10 gap-3 bg-black flex-grow"
      ...
      >
        {props.round.answers.map((x, index) => (
          <div class=" uppercase items-center text-center rounded border-2 font-extrabold">
            {x.trig ? (
              // answered question
              <div class="h-full w-full bg-gradient-to-t from-blue-800 via-blue-600 to-blue-800">
