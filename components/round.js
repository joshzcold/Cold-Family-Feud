    ...
    <div class="">
      <div class="text-center">
        <div
          ...
          class="border-black px-12 inline-block bg-gradient-to-tr
        ...
        <div class="flex flex-row items-center">
          <div
            style={{ borderWidth: 12 }}
            class="border-black bg-gradient-to-tr px-12 ml-5
          ...
          >
            ...
            >
              {t("number", { count: props.game.teams[0].points })}
            </p>
          </div>

          <div
            class="rounded-3xl border-black grid grid-rows-4 grid-flow-col  p-3 mx-10 mb-10 gap-3 bg-black flex-grow"
            style={{ borderWidth: 12 }}
          >
                ...
                {x.trig ? (
                  ...
                  <div class="h-full bg-gradient-to-t from-blue-800 via-blue-600 to-blue-800">
                    <div class="flex h-full items-center justify-center">
                      <p
                        class="text-4xl text-white px-5 flex-grow"
          ...
          <div
            style={{ borderWidth: 12 }}
            class="border-black bg-gradient-to-tr px-12 mr-5
            from-blue-900 to-blue-500 flex items-center justify-center"
          >
            <p
              class="text-white"
