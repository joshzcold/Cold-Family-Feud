...
const Donate = () => {
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link href="https://liberapay.com/joshuaCold" target="blank" rel="noopener noreferrer" className="flex gap-2 items-center">
...
const Email = () => {
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link href="mailto: joshzcold@gmail.com" className="flex gap-2 items-center">
...
const SourceCode = () => {
  ...
  return (
    <div className="flex flex-row items-center space-x-4">
      <Link href="https://github.com/joshzcold/Friendly-Feud" target="_blank" rel="noopener noreferrer" className="flex gap-2 items-center">
